...
class Transmisor(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._Ac_range = Range(0, 1, 100u, 100m, 200)
        ...
        self._A_range = Range(0, 1, 100u, 1, 200)
        ...
        self.uhd_usrp_sink_0.set_bandwidth(A, 0)
        ...
        self._Ka_range = Range(0, 4, 100u, 1, 200)
    ...
    def set_A(self, A):
        self.A = A
        self.uhd_usrp_sink_0.set_bandwidth(self.A, 0)
