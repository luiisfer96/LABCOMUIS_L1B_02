...
class Modulacion_PM(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Blocks
        ##################################################
        self._kp_range = Range(0, 100, 1e-3, 1, 200)
        self._kp_win = RangeWidget(self._kp_range, self.set_kp, "Coeficiente portadora", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self._fc_range = Range(130e6, 2.2e9, 100000, 130e6, 200)
        ...
        self._GTX_win = RangeWidget(self._GTX_range, self.set_GTX, "Ganancia del TX", "counter_slider", int, QtCore.Qt.Horizontal)
        ...
        self._Ac_range = Range(0, 1, 1e-6, 0.2, 200)
        ...
        self.connect((self.blocks_complex_to_float_0, 0), (self.CalculoPotenciaComunicaciones_0, 0))
        self.connect((self.envolventecompleja_0, 0), (self.blocks_complex_to_float_0, 0))
    ...
    def set_kp(self, kp):
        self.kp = kp
        self.envolventecompleja_0.set_kp(self.kp)
